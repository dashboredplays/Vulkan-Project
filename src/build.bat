...
SET includes=/Isrc /I%VULKAN_SDK%/Include /I"C:/Users/Matthew/glfw-3.3.9.bin.WIN64/glfw-3.3.9.bin.WIN64/include"
...
cl /EHsc /MD %includes% %defines% src/*.cpp %links% /OUT:main.exe